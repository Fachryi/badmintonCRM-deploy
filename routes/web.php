 ...
 */
Route::middleware(['auth', 'pelanggan', 'prevent-back-history'])->prefix('booking')->name('booking.')->group(function () {
...
// Profil Pelanggan
Route::middleware(['auth', 'pelanggan', 'prevent-back-history'])->prefix('profil')->name('profil.')->group(function () {
...
// Membership
Route::middleware(['auth', 'pelanggan', 'prevent-back-history'])->group(function () {
    Route::get('/membership', [ProfilController::class, 'membership'])->name('membership.index');
    Route::get('/membership/check-availability', [ProfilController::class, 'checkAvailability'])->name('membership.check-availability');
    Route::post('/membership/bayar', [ProfilController::class, 'bayarMembership'])->name('membership.bayar');
});

// Loyalty Points Pelanggan
Route::middleware(['auth', 'pelanggan', 'prevent-back-history'])->prefix('loyalty')->name('loyalty.')->group(function () {
